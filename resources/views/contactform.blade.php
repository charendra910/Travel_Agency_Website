...
<section class="section" id="contact-us" style="margin-top:0">
    ...
    <div class="contact-form section-bg" style="background-image: url({{url('frontends/assets/images/contact-1-720x480.jpg')}})">
        <form id="contact" class="form" name="contact" action="{{url('store-form')}}" method="post" >
            @csrf
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <input name="phonenumber" type="number" id="phonenumber" placeholder="PhoneNumber" >
                 ...
                 <div class="col-lg-12">
                   <fieldset>
                     <textarea  type="text" name="message" rows="6" id="message" placeholder="Message" ></textarea>
                   </fieldset>
                   <span class="text-danger">
                     @error('message')
                       {{$message}}
